  ...
  html: () => `
    ...
    <div class="sign-area">
      ...
      <div>
        ...
        <div class="sign-block"><div class="s-lbl"><input class="s-in c-company" placeholder="(주)회사명"/> 대표 귀하</div></div>
      </div>
    </div>`
},
...
employed: {
  ...
  html: () => `
    <div class="doc-law">■ 근로기준법 시행규칙 제16조</div>
  ...
  html: () => `
    ...
    <div class="sign-area">
      ...
      <div>
        ...
        <div class="sign-block"><div class="s-lbl"><input class="s-in c-company" placeholder="(주)회사명"/> 대표 귀중</div></div>
      </div>
    </div>`
},
  ...
  html: () => `
    ...
    <div class="sign-area">
      ...
      <div>
        ...
        <div class="sign-block"><div class="s-lbl"><input class="s-in c-company" placeholder="(주)회사명"/> 대표자 귀하</div></div>
      </div>
    </div>`
},
