...
'labor-refusal': {
  ...
  html: () => `
    <div class="doc-law">■ 근로기준법 제61조(연차유급휴가의 사용 촉진)</div>
    ...
    <div class="block-box" style="font-size:9pt;line-height:1.9">
      ...
      <strong>금일은 회사가 귀하의 연차휴가일로 지정한 날이므로</strong> 귀하는 금일 회사에 근로를 제공할 의무가 없고,
      회사에서는 <u>귀하의 노무수령을 거부</u>하오니, 즉시 퇴근하시기 바랍니다.<br><br>
    ...
    <div class="receipt">
      ...
      <div class="receipt-body">
        ...
        수령인: <input class="ii" placeholder="홍길동" style="width:90pt"/> &nbsp;<span class="stamp">인</span>
      </div>
    </div>`
},
...
statement: {
  ...
  html: () => `
    ...
    <div style="text-align:right;margin:8pt 0 6pt;font-size:9.5pt">
      ...
      성 명: <input class="ii" placeholder="홍길동" style="width:90pt"/> &nbsp;<span class="stamp">인</span>
    </div>
...
'committee-minutes': {
  ...
  html: () => `
    ...
    <div class="sign-area">
      <div class="sign-date"><input class="ii" placeholder="20" style="width:30pt"/>년 <input class="ii" placeholder="01" style="width:22pt"/>월 <input class="ii" placeholder="01" style="width:22pt"/>일</div>
      <div>
        <div class="sign-block" style="margin-bottom:4pt">
          <div class="s-lbl">위원장 (대표)</div>
          <input class="s-in c-ceo" placeholder="홍대표"/> <span class="stamp">인</span>
        </div>
        <div class="sign-block" style="margin-bottom:4pt">
          <div class="s-lbl">위 원</div>
          <input class="s-in" placeholder="김이사"/> <span class="stamp">인</span>
        </div>
        <div class="sign-block">
          <div class="s-lbl">위 원</div>
          <input class="s-in" placeholder="이팀장"/> <span class="stamp">인</span>
        </div>
      </div>
    </div>`
},
...
'harassment-edu': {
  ...
  html: () => `
    <div class="doc-law">■ 남녀고용평등과 일·가정 양립 지원에 관한 법률 제13조</div>
...
'harassment-list': {
  ...
  html: () => `
    ...
    <div class="sign-area">
      <div class="sign-date"><input class="ii" placeholder="20" style="width:30pt"/>년 <input class="ii" placeholder="01" style="width:22pt"/>월 <input class="ii" placeholder="01" style="width:22pt"/>일</div>
      <div class="sign-block"><div class="s-lbl"><input class="s-in c-company" placeholder="(주)회사명"/></div></div>
    </div>`
},
...
'disability-edu': {
  ...
  html: () => `
    <div class="doc-law">■ 장애인고용촉진 및 직업재활법 제5조의2</div>
