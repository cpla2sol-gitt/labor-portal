  ...
  html: () => `    
    ...
    <table class="ft" style="table-layout:fixed;width:100%;margin-bottom:0">
      ...
      <tr><td class="lbl">발생 기준</td><td class="val" colspan="3">
        <select class="di no-print" onchange="this.nextElementSibling.textContent=this.value"><option value="">— 선택 —</option><option>입사일 기준</option><option>회계연도 기준</option></select><span class="select-print-val"></span>
      </td></tr>
    </table>
