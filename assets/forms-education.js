    ...
    <table class="ft" style="margin:8pt 0">
      <tr><td class="lbl">교육 과목</td><td class="val"><input class="di" placeholder="직장 내 성희롱 예방교육"/></td>
          <td class="lbl">교육 방법</td><td class="val">
            <select class="di" onchange="this.nextElementSibling.textContent=this.value"><option value="">— 선택 —</option><option>집합 교육</option><option>온라인 교육</option><option>자체 교육</option><option>외부기관 위탁</option></select><span class="select-print-val"></span>
          </td></tr>
