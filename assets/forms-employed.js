  ...
  html: () => `
    ...
    <table class="ft">
      ...
      <tr><td class="lbl">입사일</td><td class="val"><input class="di" placeholder="2020. 03. 02."/></td>
          <td class="lbl">고용형태</td><td class="val"><select class="di" onchange="this.nextElementSibling.textContent=this.value"><option value="">— 선택 —</option><option>정규직</option><option>계약직</option><option>파견직</option><option>단시간근로자</option></select><span class="select-print-val"></span></td></tr>
      <tr><td class="lbl">용 도</td><td class="val" colspan="3"><select class="di" onchange="this.nextElementSibling.textContent=this.value"><option value="">— 선택 —</option><option>금융기관 제출용</option><option>관공서 제출용</option><option>개인 보관용</option><option>기타</option></select><span class="select-print-val"></span></td></tr>
    </table>
