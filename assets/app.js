...
/* ─────────────────────────────────────────────────────────────
   ⑯ 인쇄 전 서명란 하단 고정 (CSS margin-top:auto 인쇄 버그 우회)
   
   beforeprint: 서명란 위에 spacer 삽입 → 서명란이 항상 페이지 하단에 위치
   afterprint : spacer 제거
   ───────────────────────────────────────────────────────────── */
window.addEventListener('beforeprint', function() {
  ...
  var beforeSignH  = signArea.offsetTop - padTop;
  var signH        = signArea.offsetHeight;
  var spacerH      = contentAreaH - beforeSignH - signH;
