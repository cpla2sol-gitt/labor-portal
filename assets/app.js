...
window.addEventListener('load', function() {
  var S = window.opener && window.opener.S;
  if (!S) return;
  if (S.company) document.querySelectorAll('.c-company').forEach(function(el) { el.value = S.company; });
  if (S.ceo)     document.querySelectorAll('.c-ceo').forEach(function(el) { el.value = S.ceo; });
  if (S.addr)    document.querySelectorAll('.c-addr').forEach(function(el) { el.value = S.addr; });
  var suffix = S.recipientSuffix || '귀하';
